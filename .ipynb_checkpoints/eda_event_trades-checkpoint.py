from transactions import get_event_transactions, clean_transactions_df, _get_transactions_df
...
class EdaEventTrades:
    def __init__(self, event_id, generate_report = False):
        self.eid = event_id
    ...
    def process_transactions(self, eid):
        ...
        self.df = get_event_transactions(eid)
        #inverting dataframe
    ...
    def get_trades_info(self):
        ...
        info_dict = {"AllTotalQty":z_info.totqty,
                    ...
                    "OverallPnL":get_event_transactions(self.eid)["amount"].sum()}
        return info_dict
